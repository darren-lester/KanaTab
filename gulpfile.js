...
gulp.task("scripts-dev", ["babel"], function(){
	return gulp.src(["tmp/options.js"]).
	pipe(gulp.dest("dev/scripts"));
});
...
gulp.task("dev", ["html-dev", "json-dev", "images-dev", "mainscripts-dev", "scripts-dev", "styles-dev"]);
gulp.task("build", ["html-dist", "json-dist", "images-dist", "mainscripts-dist", "scripts-dist", "styles-dist"]);
